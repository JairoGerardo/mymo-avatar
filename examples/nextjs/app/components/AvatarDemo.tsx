...
export default function AvatarDemo() {
  ...
  return (
    <div style={S.page}>
      <h1 style={S.h1}>Mymo Avatar — Next.js</h1>
      <p style={S.subtitle}>SDK Demo — App Router + dynamic import (ssr: false)</p>
      ...
      {talking && (
        <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", width: 260 }}>
          <span style={{ fontSize: "0.7rem", color: "#a78bfa" }}>talking</span>
